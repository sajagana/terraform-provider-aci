...
func (p *AciProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewL3extRsLblToInstPResource,
		NewL3extRsLblToProfileResource,
		...
		NewMplsNodeSidPResource,
		NewNetflowMonitorPolResource,
		NewNetflowRecordPolResource,
...
func (p *AciProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewL3extRsLblToInstPDataSource,
		NewL3extRsLblToProfileDataSource,
		...
		NewMplsNodeSidPDataSource,
		NewNetflowMonitorPolDataSource,
		NewNetflowRecordPolDataSource,
